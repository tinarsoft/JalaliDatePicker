...
namespace FarsiLibrary.Win.Controls
{
	...
	/// </summary>
	public class FAMessageBox
	{
		#region Fields

		private FAMessageBoxForm _msgBox = new FAMessageBoxForm();
	    ...
	    public string Show(IWin32Window owner)
	    {
	        if (IsRightToLeft)
	        {
	            _msgBox.RightToLeft = RightToLeft.Yes;
	        }
	        else
	        {
	            _msgBox.RightToLeft = RightToLeft.No;
	        }

	        if (_useSavedResponse)
	        {
	            string savedResponse = FAMessageBoxManager.GetSavedResponse(this);
	    ...
	    public void AddButton(string text, string val)
	    {
	        ...
	        FAMessageBoxButton button = new FAMessageBoxButton(text, val);
	        AddButton(button);
	    }
	    ...
	    /// </summary>
	    internal FAMessageBox(bool isRTL)
	    {
