	...
	public abstract class BaseControl : BaseStyledControl, INotifyPropertyChanged
	{
		...
		public bool HasErrors
		{
            ...
            set
            {
                ...
                {
                    Error.SetError(this, FarsiLibrary.Resources.FALocalizeManager.GetLocalizerByCulture(System.Threading.Thread.CurrentThread.CurrentUICulture).GetLocalizedString(FarsiLibrary.Resources.StringID.Validation_NotValid));
                }
            }
		}
